#!/usr/bin/env bash
# DeiT-Tiny 1000-cal/1000-eval on the stock ExecuTorch 1.3.1 quantizer, split
...
cd "$V"
echo "== vision deit_tiny_patch16_224 1000/1000 $(date +%T) on $(hostname)"
"$PY" vision_ptq_eval.py --out-dir "$V/et131_deit_cal1000_n1000" --model-name deit_tiny_patch16_224 \
